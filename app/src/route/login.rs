...
use actix_web::{HttpResponse, post, Error};
...
pub async fn login(user: Json<LoginDao>, data: Data<AppSettings>) -> Result<HttpResponse,Error> {
    ...
    Err(ErrorUnauthorized(msg!(401, "Your name or password is error")))
}
